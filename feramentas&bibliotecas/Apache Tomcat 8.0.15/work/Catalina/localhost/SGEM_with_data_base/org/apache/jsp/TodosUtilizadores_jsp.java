 ...
 * Generated at: 2016-11-01 12:40:13 UTC
...
import classes_controladoras.SexoJpaController;
import classe.Sexo;
...
List<Cliente> clientes; List<Sexo> sexo;
...
SexoJpaController sc = new SexoJpaController(emf);
           sexo= sc.findSexoEntities();
      ...
      out.write("         ");
             ...
             for(int i = 0; i<clientes.size(); i++){
               //int id = (clientes.get(i).getIdsexo());
                        
                 //        for(int j=0; j<sexo.size();j++){
                   //          if(id == (sexo.get(j).getIdsexo())){
      ...
      out.print(clientes.get(i).getNomecliente() );
      out.write(' ');
      out.write('-');
      out.write(' ');
      out.print(sexo.get(j).getDescricao() );
      out.write("    </u></p>\n");
