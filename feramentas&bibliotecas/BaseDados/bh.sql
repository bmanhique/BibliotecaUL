...
*/
--Database name bh,user name postgres, password root
Create database bh
-- ----------------------------
-- Sequence structure for areacientifica_idarea_seq
-- ----------------------------
--DROP SEQUENCE "areacientifica_idarea_seq";
CREATE SEQUENCE "areacientifica_idarea_seq"
 INCREMENT 1
 MINVALUE 1
 MAXVALUE 9223372036854775807
 START 5
 CACHE 1;
SELECT setval('"areacientifica_idarea_seq"', 5, true);

-- ----------------------------
-- Sequence structure for arquivoestudante_idarquivo_seq
-- ----------------------------
--DROP SEQUENCE "arquivoestudante_idarquivo_seq";
CREATE SEQUENCE "arquivoestudante_idarquivo_seq"
 ...
 START 679
 CACHE 1;
SELECT setval('"arquivoestudante_idarquivo_seq"', 679, true);

-- ----------------------------
-- Sequence structure for arquivoinscricao_idarquivoi_seq
-- ----------------------------
--DROP SEQUENCE "arquivoinscricao_idarquivoi_seq";
CREATE SEQUENCE "arquivoinscricao_idarquivoi_seq"
 ...
 START 231
 CACHE 1;
SELECT setval('"arquivoinscricao_idarquivoi_seq"', 231, true);

-- ----------------------------
-- Sequence structure for arquivomatricula_idarquivom_seq
-- ----------------------------
--DROP SEQUENCE "arquivomatricula_idarquivom_seq";
CREATE SEQUENCE "arquivomatricula_idarquivom_seq"
 ...
 START 325
 CACHE 1;
SELECT setval('"arquivomatricula_idarquivom_seq"', 325, true);

-- ----------------------------
-- Sequence structure for b_leitor_id_leitor_seq
-- ----------------------------
--DROP SEQUENCE "b_leitor_id_leitor_seq";
CREATE SEQUENCE "b_leitor_id_leitor_seq"
 ...
 START 7
 CACHE 1;
SELECT setval('"b_leitor_id_leitor_seq"', 7, true);

-- ----------------------------
-- Sequence structure for b_reserva_idagenda_seq
-- ----------------------------
--DROP SEQUENCE "b_reserva_idagenda_seq";
CREATE SEQUENCE "b_reserva_idagenda_seq"
 ...
 START 9
 CACHE 1;
SELECT setval('"b_reserva_idagenda_seq"', 9, true);

-- ----------------------------
-- Sequence structure for bolsa_id_bolsa_seq
-- ----------------------------
--DROP SEQUENCE "bolsa_id_bolsa_seq";
...
-- ----------------------------
--DROP SEQUENCE "bv_artigo_idartigo_seq";
CREATE SEQUENCE "bv_artigo_idartigo_seq"
 ...
 START 7
 CACHE 1;
SELECT setval('"bv_artigo_idartigo_seq"', 7, true);

-- ----------------------------
-- Sequence structure for caracter_id_caracter_seq
-- ----------------------------
--DROP SEQUENCE "caracter_id_caracter_seq";
...
-- ----------------------------
--DROP SEQUENCE "cargochefia_idcargochefia_seq";
CREATE SEQUENCE "cargochefia_idcargochefia_seq"
 ...
 START 2
 CACHE 1;
SELECT setval('"cargochefia_idcargochefia_seq"', 2, true);

-- ----------------------------
-- Sequence structure for curso_id_curso_seq
-- ----------------------------
--DROP SEQUENCE "curso_id_curso_seq";
CREATE SEQUENCE "curso_id_curso_seq"
 ...
 START 403
 CACHE 1;
SELECT setval('"curso_id_curso_seq"', 403, true);

-- ----------------------------
-- Sequence structure for disciplina_id_disc_seq
-- ----------------------------
--DROP SEQUENCE "disciplina_id_disc_seq";
CREATE SEQUENCE "disciplina_id_disc_seq"
 ...
 START 176
 CACHE 1;
SELECT setval('"disciplina_id_disc_seq"', 176, true);

-- ----------------------------
-- Sequence structure for disciplinaanulada_idanulacao_seq
-- ----------------------------
--DROP SEQUENCE "disciplinaanulada_idanulacao_seq";
CREATE SEQUENCE "disciplinaanulada_idanulacao_seq"
 ...
 START 53
 CACHE 1;
SELECT setval('"disciplinaanulada_idanulacao_seq"', 53, true);

-- ----------------------------
-- Sequence structure for documento_id_documento_seq
-- ----------------------------
--DROP SEQUENCE "documento_id_documento_seq";
CREATE SEQUENCE "documento_id_documento_seq"
 ...
 START 1
 CACHE 1;
SELECT setval('"documento_id_documento_seq"', 1, true);
...
CREATE SEQUENCE "endereco_id_endereco_seq"
 ...
 START 10
 CACHE 1;
SELECT setval('"endereco_id_endereco_seq"', 10, true);

-- ----------------------------
-- Sequence structure for endereco_provincia_seq
-- ----------------------------
--DROP SEQUENCE "endereco_provincia_seq";
CREATE SEQUENCE "endereco_provincia_seq"
 ...
 START 3
 CACHE 1;
SELECT setval('"endereco_provincia_seq"', 3, true);

-- ----------------------------
-- Sequence structure for estudante_cursocurrente_seq
-- ----------------------------
--DROP SEQUENCE "estudante_cursocurrente_seq";
CREATE SEQUENCE "estudante_cursocurrente_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"estudante_cursocurrente_seq"', 4, true);

-- ----------------------------
-- Sequence structure for estudante_cursoingresso_seq
-- ----------------------------
--DROP SEQUENCE "estudante_cursoingresso_seq";
CREATE SEQUENCE "estudante_cursoingresso_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"estudante_cursoingresso_seq"', 4, true);

-- ----------------------------
-- Sequence structure for estudante_documento_seq
-- ----------------------------
--DROP SEQUENCE "estudante_documento_seq";
...
-- ----------------------------
--DROP SEQUENCE "estudante_endereco_ferias_seq";
...
-- ----------------------------
--DROP SEQUENCE "estudante_endereco_seq";
...
-- ----------------------------
--DROP SEQUENCE "estudante_escola_pais_seq";
CREATE SEQUENCE "estudante_escola_pais_seq"
 ...
 START 5
 CACHE 1;
SELECT setval('"estudante_escola_pais_seq"', 5, true);

-- ----------------------------
-- Sequence structure for estudante_escola_provincia_seq
-- ----------------------------
--DROP SEQUENCE "estudante_escola_provincia_seq";
...
-- ----------------------------
--DROP SEQUENCE "estudante_id_estudante_seq";
CREATE SEQUENCE "estudante_id_estudante_seq"
 ...
 START 290
 CACHE 1;
SELECT setval('"estudante_id_estudante_seq"', 290, true);

-- ----------------------------
-- Sequence structure for estudante_nacionalidade_seq
-- ----------------------------
--DROP SEQUENCE "estudante_nacionalidade_seq";
CREATE SEQUENCE "estudante_nacionalidade_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"estudante_nacionalidade_seq"', 4, true);

-- ----------------------------
-- Sequence structure for estudante_profissao_seq
-- ----------------------------
--DROP SEQUENCE "estudante_profissao_seq";
...
-- ----------------------------
--DROP SEQUENCE "estudante_provincia_admissao_seq";
...
-- ----------------------------
--DROP SEQUENCE "faculdade_director_seq";
...
-- ----------------------------
--DROP SEQUENCE "faculdade_id_faculdade_seq";
CREATE SEQUENCE "faculdade_id_faculdade_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"faculdade_id_faculdade_seq"', 4, true);

-- ----------------------------
-- Sequence structure for funcionario_id_funcionario_seq
-- ----------------------------
--DROP SEQUENCE "funcionario_id_funcionario_seq";
CREATE SEQUENCE "funcionario_id_funcionario_seq"
 ...
 START 19
 CACHE 1;
SELECT setval('"funcionario_id_funcionario_seq"', 19, true);

-- ----------------------------
-- Sequence structure for grupoinscricao_idgrupoi_seq
-- ----------------------------
--DROP SEQUENCE "grupoinscricao_idgrupoi_seq";
CREATE SEQUENCE "grupoinscricao_idgrupoi_seq"
 ...
 START 154
 CACHE 1;
SELECT setval('"grupoinscricao_idgrupoi_seq"', 154, true);

-- ----------------------------
-- Sequence structure for ingressobolseiro_id_estudante_seq
-- ----------------------------
--DROP SEQUENCE "ingressobolseiro_id_estudante_seq";
CREATE SEQUENCE "ingressobolseiro_id_estudante_seq"
 ...
 START 1
 CACHE 1;
SELECT setval('"ingressobolseiro_id_estudante_seq"', 1, true);

-- ----------------------------
-- Sequence structure for ingressomudancauniversidade_id_estudante_seq
-- ----------------------------
--DROP SEQUENCE "ingressomudancauniversidade_id_estudante_seq";
CREATE SEQUENCE "ingressomudancauniversidade_id_estudante_seq"
 ...
 START 5
 CACHE 1;
SELECT setval('"ingressomudancauniversidade_id_estudante_seq"', 5, true);

-- ----------------------------
-- Sequence structure for ingressomudancauniversidade_pais_universidade_seq
-- ----------------------------
--DROP SEQUENCE "ingressomudancauniversidade_pais_universidade_seq";
...
-- ----------------------------
--DROP SEQUENCE "ingressopercabolsa_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "ingressotransferencia_curso_seq";
...
-- ----------------------------
--DROP SEQUENCE "ingressotransferencia_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "inscricao_funcionario_seq";
...
-- ----------------------------
--DROP SEQUENCE "inscricao_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "inscricao_id_inscricao_seq";
CREATE SEQUENCE "inscricao_id_inscricao_seq"
 ...
 START 1205
 CACHE 1;
SELECT setval('"inscricao_id_inscricao_seq"', 1205, true);

-- ----------------------------
-- Sequence structure for inscricaodisciplina_id_disciplina_seq
-- ----------------------------
--DROP SEQUENCE "inscricaodisciplina_id_disciplina_seq";
...
-- ----------------------------
--DROP SEQUENCE "inscricaodisciplina_id_inscricao_seq";
...
-- ----------------------------
--DROP SEQUENCE "levprescricao_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "listaadmissao_curso_seq";
...
-- ----------------------------
--DROP SEQUENCE "listaadmissao_idaluno_seq";
CREATE SEQUENCE "listaadmissao_idaluno_seq"
 ...
 START 88
 CACHE 1;
SELECT setval('"listaadmissao_idaluno_seq"', 88, true);

-- ----------------------------
-- Sequence structure for matricula_curso_seq
-- ----------------------------
--DROP SEQUENCE "matricula_curso_seq";
...
-- ----------------------------
--DROP SEQUENCE "matricula_funcionario_seq";
...
-- ----------------------------
--DROP SEQUENCE "matricula_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "matriculaanulada_ano_seq";
...
-- ----------------------------
--DROP SEQUENCE "matriculaanulada_funcionario_seq";
...
-- ----------------------------
--DROP SEQUENCE "matriculaanulada_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "mudancacurso_curso_destino_seq";
...
-- ----------------------------
--DROP SEQUENCE "mudancacurso_curso_origem_seq";
...
-- ----------------------------
--DROP SEQUENCE "mudancacurso_id_estudante_seq";
...
-- ----------------------------
--DROP SEQUENCE "mudancacurso_idmudanca_seq";
...
CREATE SEQUENCE "notificacao_id_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"notificacao_id_seq"', 4, true);

-- ----------------------------
-- Sequence structure for operacaopedido_idpermissao_seq
-- ----------------------------
--DROP SEQUENCE "operacaopedido_idpermissao_seq";
CREATE SEQUENCE "operacaopedido_idpermissao_seq"
 ...
 START 4
 CACHE 1;
SELECT setval('"operacaopedido_idpermissao_seq"', 4, true);
...
-- ----------------------------
--DROP SEQUENCE "periodo_id_periodo_seq";
...
-- ----------------------------
--DROP SEQUENCE "permissao_idpermissao_seq";
...
-- ----------------------------
--DROP SEQUENCE "profissao_endereco_seq";
...
-- ----------------------------
--DROP SEQUENCE "profissao_idprofissao_seq";
CREATE SEQUENCE "profissao_idprofissao_seq"
 ...
 START 58
 CACHE 1;
SELECT setval('"profissao_idprofissao_seq"', 58, true);
...
-- ----------------------------
--DROP SEQUENCE "reserva_idagenda_seq";
CREATE SEQUENCE "reserva_idagenda_seq"
 ...
 START 16
 CACHE 1;
SELECT setval('"reserva_idagenda_seq"', 16, true);

-- ----------------------------
-- Sequence structure for sg_autor_id_autor_seq
-- ----------------------------
--DROP SEQUENCE "sg_autor_id_autor_seq";
CREATE SEQUENCE "sg_autor_id_autor_seq"
 ...
 START 15
 CACHE 1;
SELECT setval('"sg_autor_id_autor_seq"', 15, true);

-- ----------------------------
-- Sequence structure for sg_emprestimo_id_emprestimo_seq
-- ----------------------------
--DROP SEQUENCE "sg_emprestimo_id_emprestimo_seq";
CREATE SEQUENCE "sg_emprestimo_id_emprestimo_seq"
 ...
 START 33
 CACHE 1;
SELECT setval('"sg_emprestimo_id_emprestimo_seq"', 33, true);

-- ----------------------------
-- Sequence structure for sg_exemplar_nr_registo_seq
-- ----------------------------
--DROP SEQUENCE "sg_exemplar_nr_registo_seq";
CREATE SEQUENCE "sg_exemplar_nr_registo_seq"
 ...
 START 33
 CACHE 1;
SELECT setval('"sg_exemplar_nr_registo_seq"', 33, true);

-- ----------------------------
-- Sequence structure for sg_obra_id_livro_seq
-- ----------------------------
--DROP SEQUENCE "sg_obra_id_livro_seq";
CREATE SEQUENCE "sg_obra_id_livro_seq"
 ...
 START 14
 CACHE 1;
SELECT setval('"sg_obra_id_livro_seq"', 14, true);

-- ----------------------------
-- Sequence structure for sgemprestimoparametro_idparametro_seq
-- ----------------------------
--DROP SEQUENCE "sgemprestimoparametro_idparametro_seq";
...
-- ----------------------------
--DROP SEQUENCE "tipodocumento_id_tipo_seq";
...
-- ----------------------------
--DROP SEQUENCE "users_id_utilizador_seq";
...
-- Records of b_leitor
-- ----------------------------
INSERT INTO "b_leitor" VALUES ('1', 'Estudante', null, '2016-09-01', '1', null, null, null, null, null, null, null, 'omuquissirima', 'Activo', null, null);
INSERT INTO "b_leitor" VALUES ('2', 'Funcionario', null, '2016-09-01', '1', null, null, null, null, null, null, null, 'basilissa.miguel', 'Activo', null, null);
INSERT INTO "b_leitor" VALUES ('3', 'Visitante', null, '2016-09-01', '1', null, null, '040100445553Q', 'cnobrega@unilurio.ac.mz', 'AV. Eduardo Mondlane, Nanhimbe', 'Chaquil Kahlid Ossumane Nobrega', '845091838', null, 'Activo', null, null);
INSERT INTO "b_leitor" VALUES ('4', 'Estudante', null, '2016-09-02', '1', null, null, null, null, null, null, null, 'ejunior', 'Activo', null, null);
INSERT INTO "b_leitor" VALUES ('5', 'Visitante', null, '2016-09-02', '1', null, null, '289388726718327', 'a', 'expansao', 'Armando Umusse', '825415264', null, 'Activo', null, null);
INSERT INTO "b_leitor" VALUES ('6', 'Estudante', null, '2016-10-19', '1', null, null, null, null, null, null, null, 'antauali', 'Activo', 'yelen.rocha', null);
INSERT INTO "b_leitor" VALUES ('7', 'Estudante', null, '2016-10-19', '1', null, null, null, null, null, null, null, 'agabriel', 'Activo', 'yelen.rocha', null);
...
-- ----------------------------
INSERT INTO "b_notificacao" VALUES ('2', 'esilva', 'artigo 67 da biblioteca ', null, null, '2016-09-02', '3');
INSERT INTO "b_notificacao" VALUES ('3', 'omuquissirima', 'roubou', null, null, '2016-09-10', '3');
INSERT INTO "b_notificacao" VALUES ('4', 'esilva', 'não pagou multas', null, null, '2016-09-13', '3');
...
-- ----------------------------
INSERT INTO "b_reserva" VALUES ('1', '2016-08-24', '2016-08-19', 'Cancelada', '16', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('2', '2016-08-24', '2016-08-19', 'Cancelada', '1', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('3', '2016-08-22', '2016-08-19', 'Pendente', '16', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('4', '2016-08-25', '2016-08-20', 'Cancelada', '16', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('5', '2016-08-27', '2016-08-20', 'Pendente', '5', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('6', '2016-08-26', '2016-08-20', 'Cancelada', '1', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('7', '2016-08-26', '2016-08-21', 'Pendente', '1', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('8', '2016-08-10', '2016-08-22', 'Cancelada', '1', null, null, null, null);
INSERT INTO "b_reserva" VALUES ('9', '2016-08-12', '2016-08-24', 'Pendente', '10', null, null, null, null);
...
-- ----------------------------
INSERT INTO "sg_emprestimo_parametros" VALUES ('1', 'esilva', null, '30', 'Taxa para criação do cartão de leitor');
INSERT INTO "sg_emprestimo_parametros" VALUES ('2', 'esilva', null, '30', 'Taxa para renovação do cartão de leitor');
INSERT INTO "sg_emprestimo_parametros" VALUES ('3', 'esilva', null, '25', 'Taxa de espera');
...
-- ----------------------------
INSERT INTO "sg_exemplar" VALUES ('1', '2016-08-19', '2016-08-19', 'Disponivel', 'Oferta', 'uss', '2', null);
INSERT INTO "sg_exemplar" VALUES ('2', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '2', null);
INSERT INTO "sg_exemplar" VALUES ('3', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '2', null);
INSERT INTO "sg_exemplar" VALUES ('4', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '2', null);
INSERT INTO "sg_exemplar" VALUES ('5', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '3', null);
INSERT INTO "sg_exemplar" VALUES ('6', '2016-08-19', '2016-08-19', 'Disponivel', 'Oferta', 'uss', '3', null);
INSERT INTO "sg_exemplar" VALUES ('7', '2016-08-19', '2016-08-19', 'Disponivel', 'Oferta', 'uss', '3', null);
INSERT INTO "sg_exemplar" VALUES ('10', '2016-08-19', '2016-08-19', 'Emprestado', 'Oferta', 'uss', '4', null);
INSERT INTO "sg_exemplar" VALUES ('11', '2016-08-19', '2016-08-19', 'Emprestado', 'Compra', 'uss', '4', null);
INSERT INTO "sg_exemplar" VALUES ('12', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '4', null);
INSERT INTO "sg_exemplar" VALUES ('13', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '5', null);
INSERT INTO "sg_exemplar" VALUES ('14', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '5', null);
INSERT INTO "sg_exemplar" VALUES ('15', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '5', null);
INSERT INTO "sg_exemplar" VALUES ('16', '2016-08-19', '2016-08-19', 'Disponivel', 'Compra', 'uss', '1', null);
INSERT INTO "sg_exemplar" VALUES ('19', '2016-09-01', '2016-09-06', 'Fixo', 'Compra', 'esilva', '9', null);
INSERT INTO "sg_exemplar" VALUES ('22', '2016-09-05', '2016-09-06', 'Fixo', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('23', '2016-08-30', '2016-09-06', 'Fixo', 'Oferta', 'esilva', '11', null);
INSERT INTO "sg_exemplar" VALUES ('24', '2016-08-31', '2016-09-09', 'Disponivel', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('25', '2016-09-05', '2016-09-09', 'Disponivel', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('26', '2016-09-05', '2016-09-09', 'Emprestado', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('27', '2016-09-05', '2016-09-09', 'Disponivel', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('28', '2016-09-07', '2016-09-09', 'Disponivel', 'Oferta', 'esilva', '10', null);
INSERT INTO "sg_exemplar" VALUES ('29', '2016-09-05', '2016-09-14', 'Fixo', 'Oferta', 'esilva', '12', null);
INSERT INTO "sg_exemplar" VALUES ('30', '2016-09-05', '2016-09-14', 'Disponivel', 'Oferta', 'esilva', '12', null);
INSERT INTO "sg_exemplar" VALUES ('31', '2016-10-10', '2016-10-19', 'Fixo', 'Oferta', 'yelen.rocha', '13', null);
INSERT INTO "sg_exemplar" VALUES ('32', '2016-10-10', '2016-10-19', 'Emprestado', 'Oferta', 'yelen.rocha', '13', null);
INSERT INTO "sg_exemplar" VALUES ('33', '2016-10-19', '2016-10-19', 'Fixo', 'Oferta', 'yelen.rocha', '14', null);
...
-- ----------------------------
INSERT INTO "sg_obra_autor" VALUES ('1', '13', '2016-10-19');
INSERT INTO "sg_obra_autor" VALUES ('1', '14', '2016-10-19');
INSERT INTO "sg_obra_autor" VALUES ('5', '9', '2016-09-06');
INSERT INTO "sg_obra_autor" VALUES ('5', '11', '2016-09-06');
INSERT INTO "sg_obra_autor" VALUES ('7', '9', '2016-09-06');
INSERT INTO "sg_obra_autor" VALUES ('8', '11', '2016-09-06');
INSERT INTO "sg_obra_autor" VALUES ('9', '9', '2016-09-06');
INSERT INTO "sg_obra_autor" VALUES ('9', '11', '2016-09-06');
...
-- ----------------------------
INSERT INTO "usergrupo" VALUES ('Administrador', 'uss', '2016-08-24');
INSERT INTO "usergrupo" VALUES ('Avaliador', 'esilva', '2016-08-16');
INSERT INTO "usergrupo" VALUES ('Bibliotecario', 'cjalilo', '2016-09-11');
INSERT INTO "usergrupo" VALUES ('Bibliotecario', 'esilva', '2016-08-25');
INSERT INTO "usergrupo" VALUES ('Bibliotecario', 'yelen.rocha', '2016-09-17');
INSERT INTO "usergrupo" VALUES ('Gestor Bibliotecario', 'esilva', '2016-09-11');
INSERT INTO "usergrupo" VALUES ('Gestor Bibliotecario', 'omuquissirima', '2016-09-11');
INSERT INTO "usergrupo" VALUES ('Leitor', 'aalfredo', '2016-08-25');
INSERT INTO "usergrupo" VALUES ('Leitor', 'echinowawa', '2016-08-22');
INSERT INTO "usergrupo" VALUES ('Leitor', 'esilva', '2016-08-16');
...
-- ----------------------------
ALTER TABLE "b_notificacao" ADD PRIMARY KEY ("id_notificacao");
...
-- ----------------------------
ALTER TABLE "usergrupo" ADD PRIMARY KEY ("id_grupo", "utilizador", "data_alocacao");
...
-- ----------------------------
-- Foreign Key structure for table "b_notificacao"
-- ----------------------------
ALTER TABLE "b_notificacao" ADD FOREIGN KEY ("id_reserva") REFERENCES "b_reserva" ("idagenda") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "b_notificacao" ADD FOREIGN KEY ("id_leitor") REFERENCES "b_leitor" ("nr_cartao") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "b_notificacao" ADD FOREIGN KEY ("id_publicacao") REFERENCES "bv_artigo" ("idartigo") ON DELETE CASCADE ON UPDATE CASCADE;
